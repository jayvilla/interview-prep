...
YOur quirky boss foudn out that you're a programmer and has a weird request about
...
would output 4-the number of ways to make 4c with those denominations
  ...
  const exampleDenominations = [1, 2, 3];

  console.log(makingChanges(exampleAmount, exampleDenominations));
